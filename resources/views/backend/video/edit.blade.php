            ...
            <div class="x_content">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('video.update',$video->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select name="cat_id" class="form-control" id="cat_id" required="required">
                                @foreach ($cats as $cat)
                                    <option value="{{$cat->id}}"{{($video->category->id == $cat->id) ? 'selected' : ''}}>{{$cat->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="title" name="title" value="{{$video->title}}" required="required" class="form-control" placeholder="Enter video title">
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea name="description" class="form-control" id="description"  rows="10" placeholder="Enter Video Description">{{$video->description}}</textarea>
                        </div>

...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Add Video Playlist</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <a href="{{route('video.playlist.index')}}" class="btn btn-outline-info btn-sm">Back</a>
            ...
            <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('video.playlist.store')}}">
                    @csrf

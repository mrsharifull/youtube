...
@section('title','Update Video Playlist')
@push('css_link')
...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit Vidao Playlist</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <a href="{{route('video.cat.index')}}" class="btn btn-outline-info btn-sm">Back</a>
            ...
            <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('video.cat.update',$cat->id)}}">
                    @csrf
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="name" value="{{$cat->name}}" name="name" required="required" class="form-control" placeholder="Enter name">
                        </div>
